...
test("Campaign Round 3 keeps Phase B, repaired Phase3 chain and Vine-only V15", () => {
  ...
  assert.match(logspireScene, /logspire_jump_rebalance_v3_titan_tree_accessibility\.gd/);
  assert.match(logspireScene, /logspire_ladder_system_v6_vine_only_cleanup\.gd/);
});
