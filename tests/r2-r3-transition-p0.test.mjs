...
const phase3Base = read('godot/modes/logspire_leap/logspire_phase3_director.gd');
...
test('Round 3 campaign scene uses repaired Phase3 chain, Vine-only V15 and V5 route clearance', () => {
