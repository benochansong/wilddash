...
test('Round 3 campaign scene uses stable gameplay plus the V13 guard over V12 reliability authority', () => {
  assert.match(round3Scene, /P0 CAMPAIGN-SAFE ROUND 3/);
  assert.match(round3Scene, /logspire_leap_v4_phase_b\.gd/);
  assert.match(round3Scene, /logspire_water_recovery_v13_integrated_qa\.gd/);
