...
const round3ModeV4 = readFileSync("godot/modes/logspire_leap/logspire_leap_v4_phase_b.gd", "utf8");
...
test("Round 3 restores forgiving pickup while preventing multi-box sweeps", () => {
  ...
  assert.match(round3ModeV4, /extends "res:\/\/modes\/logspire_leap\/logspire_leap_v3_recovery_camera\.gd"/);
