...
const PLAYSTYLES: Dictionary = {
	...
	&"monkey": "기술적인 Shortcut과 Fruit Frenzy 같은 수집 모드에서 강한 고기동 캐릭터.",
	&"elephant": "충돌을 피하지 않고 상대를 밀어내며 정면 돌파하는 최대 중량 Tank.",
	&"bear": "다양한 자연 지형에서 강하고 몸싸움까지 가능한 Heavy All-Terrain 캐릭터.",
	&"panda": "극단적인 장점보다 실수를 잘 받아주는 안정적인 Heavy 캐릭터.",
	&"cat": "좁은 길과 장애물 사이를 정확하게 통과하는 고난도 Precision 캐릭터.",
